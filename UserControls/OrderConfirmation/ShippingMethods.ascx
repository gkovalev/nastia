<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShippingMethods.ascx.cs"
    Inherits="Admin_UserControls_ShippingRates" %>
    ...
    <ItemTemplate>
        <tr onclick="setValueShipping(this);" id='<%# PefiksId +  Eval("Id") %>'>
            ...
            <td class="shipping-img">
                <img src='<%# ShippingIcons.GetShippingIcon((ShippingType)Eval("Type"), Eval("IconName") as string , Convert.ToString(Eval("MethodNameRate"))) %>'
            ...
            <td class="cost">
                <%# AdvantShop.Catalog.CatalogService.GetStringPrice(Convert.ToDecimal(Eval("Rate")))%>
            </td>
