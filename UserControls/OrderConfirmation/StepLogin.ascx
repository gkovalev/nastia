    ...
    <div class="form-addon-text">
        ...
        <div class="new-user-text">
            <adv:Button Text="<%$ Resources:Resource,Client_OrderConfirmation_OrderConfirmationWithoutReg%>"
                ID="bntGoQReg" Size= "Big" Type="Confirm" runat="server" OnClick="bntGoQReg_Click"
        ...
        <div class="btn-new-users">
            <adv:Button ID="btnGoWithReg" OnClick="btnGoWithReg_Click" Type="Action" Size="Middle"
                ...
                DisableValidation="True"></adv:Button>
                 <!-- Remarked by Evgeni to up notregistered text          <adv:Button Text="<%$ Resources:Resource,Client_OrderConfirmation_OrderConfirmationWithoutReg%>"
                ID="Button1" Size="Middle" Type="Confirm" runat="server" OnClick="bntGoQReg_Click"
                DisableValidation="True" /> -->
