...
<div class="auth-social" runat="server" id="divSocial">
    ...
    <div>
        ...
        <a href="javascript:void(0)" id="lnkbtnMail" runat="server">
            <img src="images/buttons/ml.png" alt="Mail.ru" title="Mail.ru" /></a>
        <br />
    </div>
</div>
<div style="display: none;" runat="server" id="pnlMail">
    <div id="modalMail" class="modalDiv">
        <br />
        <adv:AdvTextBox ValidationType="None" ID="txtOauthUserId" DefaultButtonID="btnOpenID" runat="server" />
        @mail.ru
        <br />
        <br />
        <div style="text-align: right;">
            <adv:Button ID="btnOpenID" runat="server" OnClick="lnkbtnMailClick" Type="Confirm" Size="Middle"
                Text="OK" OnClientClick="if(!$('#txtOauthUserId').val().length) return false;"
