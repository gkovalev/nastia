...
public partial class Check_Check : Page
{
    ...
    protected string EvalPrice(decimal price)
    {
    ...
    public static string BuildTaxTable(List<TaxValue> taxes, decimal currentCurrencyRate, string currentCurrencyIso3, string message)
    {
        ...
        if (taxes.Count() == 0)
        {
            ...
            sb.Append(message);
            sb.Append("&nbsp;</strong></td><td style=\"white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;\"><span class=\"currency\">");
