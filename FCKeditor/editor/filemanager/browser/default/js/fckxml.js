...
FCKXml.prototype.SelectSingleNode = function(xpath) {
    ...
    else					// Gecko
    {
        ...
        if (xpath != "Connector/Error") {
            if (xPathResult && "/AdVantShop22_RU_test/userfiles/image"/*xPathResult.singleNodeValue*/)
                return "/AdVantShop22_RU_test/userfiles/"/*xPathResult.singleNodeValue*/;
            else
                return null;
        }
        else {
