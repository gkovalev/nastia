...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Check_Check.aspx.cs" Inherits="Check_Check" %>
        ...
        <tr>
            <td>
                ...
                <table cellspacing="0" cellpadding="3" width="100%" border="1" summary="Products">
                    ...
                    <td align="right" nowrap="nowrap"><span class="currency"><asp:Literal ID="Literal1" runat="server" Text='<%# EvalPrice((decimal) Eval("Price")) %>'></asp:Literal> </span>&nbsp;&nbsp;</td>
                    <td align="center"><asp:Literal ID="Literal2" runat="server" Text='<%# Eval("Amount") %>'></asp:Literal></td>
                    <td align="right" nowrap="nowrap" style="padding-right: 5px;"><span class="currency"><asp:Literal ID="Literal3" runat="server" Text='<%# EvalPrice((Convert.ToDecimal(Eval("Price")) * Convert.ToDecimal(Eval("Amount"))))  %>'></asp:Literal> </span></td>
                    </tr>
                    </ItemTemplate>
                    </asp:Repeater>
