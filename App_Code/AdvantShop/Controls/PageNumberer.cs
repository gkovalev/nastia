...
namespace AdvantShop.Controls
{
    ...
    public class PageNumberer : WebControl, IPostBackEventHandler
    {
        ...
        public int CurrentPageIndex
        {
            get
            {
                if (_selectedPage == 0)
                {
                    ...
                    _selectedPage = (o != null) ? (Convert.ToInt32(o)) : 1;
                }
        ...
        public int PageCount
        {
            get
            {
                if (_count == - 1)
                {
                    ...
                    _count = (o != null) ? (Convert.ToInt32(o)) : 1;
                }
                return _count;
            }
            set
        ...
        public int DisplayedPages
        {
            get
            {
                if (_displayedPages == 0)
                {
                    ...
                    _displayedPages = (o != null) ? (Convert.ToInt32(o)) : 1;
                }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                CurrentPageIndex = Convert.ToInt32(curPage);
            }
            else
            {
                return;
