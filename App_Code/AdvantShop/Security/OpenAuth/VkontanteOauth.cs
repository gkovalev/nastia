...
namespace AdvOpenAuth
{
    public class VkontakteOauth
    {
        ...
        public static void VkontakteAuth(string code, string redirectUrl, string email)
        {
            try
            {
                var request = WebRequest.Create(string.Format("https://api.vk.com/oauth/access_token?client_id={0}&client_secret={1}&code={2}&redirect_uri={3}",
            ...
            {
                Debug.LogError(ex + "   code:" + code + "   redirectUrl:" + redirectUrl);
            }
        }
