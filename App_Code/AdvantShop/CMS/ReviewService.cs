...
namespace AdvantShop.CMS
{
    public class ReviewService
    {
        ...
        {
            SQLDataAccess.ExecuteNonQuery("UPDATE [CMS].[Review] SET [ParentId] = @ParentId, [EntityId] = @EntityId, [Type] = @Type, [CustomerId] = @CustomerId, [Name] = @Name, [Email] = @Email, [Text] = @Text , [Checked] = @Checked  WHERE reviewId = @reviewId",
                CommandType.Text,
