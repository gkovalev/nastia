<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cnhelper.aspx.cs" Inherits="Tools_cnhelper" %>
...
<body>
    ...
    <span style="font-family: Tahoma; font-weight: bold;">AdvantShop.NET tools for 3.x</span> - <asp:HyperLink ID="HyperLink6" runat="server" 
    ...
    <div class="ContentDiv">
        ...
        <%--Data Source='SERVER\SQL2005'; Connect Timeout='5'; Initial Catalog='AdvantShop_30'; Persist Security Info='True'; User ID='sa'; Password='ewqEWQ321#@!';--%>

        <%--Data Source='MyServerName'; Initial Catalog='MyDBName'; Integrated Security='True';--%>
        ...
        <table id="tableParams">
          ...
          <%--  <tr>
                <td>Password:</td>
                <td><asp:TextBox ID="TextBox8" runat="server" CssClass="clsText" Width="250px"></asp:TextBox></td>
            </tr>--%>
        </table>
        <br />
