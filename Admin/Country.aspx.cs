...
public partial class Admin_Country : System.Web.UI.Page
{
    ...
    {
        Page.Title = string.Format("{0} - {1}", AdvantShop.Configuration.SettingsMain.ShopName, Resources.Resource.Admin_Country_SubHeader);
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (grid.UpdatedRow != null)
        {
            var country = new Country
            {
                CountryID = Convert.ToInt32(grid.UpdatedRow["ID"]),
