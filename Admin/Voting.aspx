<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Voting.aspx.cs" Inherits="Admin_Voting" %>
                    ...
                    <asp:Panel runat="server" ID="filterPanel" DefaultButton="btnFilter">
                        <table class="filter" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; width: 120px;">
                                    <asp:DropDownList ID="ddlIsHaveNullVoice" TabIndex="18" CssClass="dropdownselect"
                                        runat="server">
                                        <asp:ListItem Selected="True" Text="<%$ Resources:Resource, Admin_Catalog_Any %>"
                                            Value="any" />
                                        <asp:ListItem Text="<%$ Resources:Resource, Admin_Catalog_Yes %>" Value="1" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                CellPadding="0" CellSpacing="0" Confirmation="<%$ Resources:Resource, Admin_Voting_Confirmation %>"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Answers" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="IsHaveNullVoice" ItemStyle-HorizontalAlign="Center"
                                        FooterStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="IsClose" ItemStyle-HorizontalAlign="Center"
                                        FooterStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="AnswerCount" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="120px" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbOrderAnswerCount" runat="server" CommandName="Sort" CommandArgument="AnswerCount">
                                                ...
                                                <asp:Image ID="arrowAnswerCount" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif"
                                    ...
                                    <asp:TemplateField ItemStyle-Width="60px" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <EditItemTemplate>
                                            <a id="cmdlink" runat="server" href='<%# "~/Admin/Answers.aspx?theme=" + Eval("ID") %>'
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteTheme" CommandArgument='<%# Eval("ID")%>'
