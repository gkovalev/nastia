<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="CustomersGroups.aspx.cs" Inherits="CustomersGroups" %>
                        ...
                        <div style="float: right; padding-right: 20px">
                            ...
                            <div>
                                <adv:AdvButton ID="btnAddCustomerGroup" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_CustomerGroup_Add %>"
                                    ...
                                    CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddCustomerGroup_Click" />
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <table class="filter" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox CssClass="filtertxtbox" ID="txtGroupName" Width="99%" runat="server"
                                    TabIndex="12" />
                            </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                            CellPadding="2" CellSpacing="0" Confirmation="<%$ Resources:Resource, Admin_CustomerGroup_QDelete %>"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField AccessibleHeaderText="GroupDiscount" HeaderStyle-HorizontalAlign="Left"
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                            CssClass="deletebtn showtooltip" CommandName="DeleteCustomerGroup" CommandArgument='<%# Eval("ID")%>'
                                            Visible='<%# (SQLDataHelper.GetInt(Eval("ID")) != CustomerGroupService.DefaultCustomerGroup) %>' ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' />
                                    ...
                                    <FooterTemplate>
                                        <asp:ImageButton ID="ibAddCustomerGroup" runat="server" ImageUrl="images/addbtn.gif"
                                            CommandName="AddCustomerGroup" ToolTip="<%$ Resources:Resource, Admin_CustomerGroup_Add  %>" />
                                        <asp:ImageButton ID="ibCancelAdd" runat="server" ImageUrl="images/cancelbtn.png"
                                            CommandName="CancelAdd" ToolTip="<%$ Resources:Resource, Admin_CustomerGroup_Add  %>" />
                                    </FooterTemplate>
                                </asp:TemplateField>
                            </Columns>
