...
public partial class Admin_AuxPage : Page
{
    ...
    protected void SaveStaticPage()
    {
        ...
        page.ParentId = Convert.ToInt32(hfParentId.Value);
        ...
        page.Meta = new MetaInfo(0, StaticPageId, MetaType.StaticPage, txtPageTitle.Text, txtMetaKeywords.Text,
