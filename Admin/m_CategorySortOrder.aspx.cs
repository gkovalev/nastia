...
public partial class Admin_m_CategorySortOrder : Page
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        {
            CategoryService.UpdateCategorySortOrder(Convert.ToString(grid.UpdatedRow["Name"]),
                                                    Convert.ToInt32(grid.UpdatedRow["SortOrder"]),
                                                    Convert.ToInt32(grid.UpdatedRow["CategoryID"]));
        }
