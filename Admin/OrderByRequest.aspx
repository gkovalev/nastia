<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="OrderByRequest.aspx.cs" Inherits="OrderByRequest" %>
                    ...
                    <table class="filter" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox CssClass="filtertxtbox" ID="txtProductName" Width="99%" runat="server" TabIndex="12" />
                            </td>
                            <td>
                                <div style="width: 300px; font-size: 0px; height: 0px;">
                                </div>
                                <asp:TextBox CssClass="filtertxtbox" ID="txtUserName" Width="99%" runat="server" TabIndex="12" />
                            </td>
                    ...
                    <ContentTemplate>
                        <adv:AdvGridView ID="grid" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField AccessibleHeaderText="ID" ItemStyle-HorizontalAlign="Center"
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <a href='<%# "EditOrderByRequest.aspx?ID=" + Eval("ID") %>' class="showtooltip"
