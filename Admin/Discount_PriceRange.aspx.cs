...
partial class Admin_Discount_PriceRange : System.Web.UI.Page
{
    ...
    protected void grid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                DeleteOrderPriceDiscount(Convert.ToInt32(e.CommandArgument));
            }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Page.Title = string.Format("{0} - {1}", AdvantShop.Configuration.SettingsMain.ShopName, Resource.Admin_Discount_PriceRange_SubHeader);
    ...
    protected void lbDeleteSelected_Click(object sender, EventArgs e)
    {
        if ((_selectionFilter != null) && (_selectionFilter.Values != null))
        {
            ...
            if (!_inverseSelection)
            {
                ...
                {
                    DeleteOrderPriceDiscount(Convert.ToInt32(id));
                }
            }
            else
            {
    ...
    public Admin_Discount_PriceRange()
    {
