...
public partial class CustomersGroups : Page
{
    ...
    protected void grid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            CustomerGroupService.DeleteCustomerGroup(Convert.ToInt32(e.CommandArgument));
        }
        ...
        if (e.CommandName == "AddCustomerGroup")
        {
            ...
            decimal discount = 0;
            if (!decimal.TryParse(((TextBox)footer.FindControl("txtNewGroupDiscount")).Text, out discount))
            {
                discount = -1;
            }
