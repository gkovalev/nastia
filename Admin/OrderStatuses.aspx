<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="OrderStatuses.aspx.cs" Inherits="Admin_OrderStatuses" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanelGrid" runat="server">
                            ...
                            <ContentTemplate>
                                <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                    ...
                                    OnRowCommand="grid_RowCommand" ShowFooterWhenEmpty="true" OnRowDeleting="grid_OnRowDeleting">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="checkboxcolumnheader" ItemStyle-CssClass="checkboxcolumn"
                                            ...
                                            <ItemTemplate>
                                                <%--<input id="Hidden1" runat="server" type="hidden" class="nonEditRow" />--%>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="StatusName" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtStatusName" runat="server" Text='<%# Eval("StatusName").ToString() %>'>
                                                </asp:TextBox>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="IsDefault" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <EditItemTemplate>
                                                <adv:PlainCheckBox runat="server" ID="chkIsDefault" Checked='<%# Eval("IsDefault") %>'
                                                    Enabled='<%# !(Convert.ToBoolean(Eval("Canceled")) || Convert.ToBoolean(Eval("IsDefault"))) %>'
                                                    CssClass='<%# "switchCheckbox" + ((Convert.ToBoolean(Eval("Canceled")) || Convert.ToBoolean(Eval("IsDefault"))) ? " add" : "")  %>'>
                                                </adv:PlainCheckBox>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Canceled" ItemStyle-HorizontalAlign="Center"
                                            FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="200">
                                            <HeaderTemplate>
                                                <div style="height: 0px; width: 130px; font-size: 0px;">
                                                </div>
                                            ...
                                            <EditItemTemplate>
                                                <adv:PlainCheckBox runat="server" ID="chkCanceled" Checked='<%# Eval("Canceled") %>'
                                                    Enabled='<%# !(Convert.ToBoolean(Eval("Canceled")) || Convert.ToBoolean(Eval("IsDefault"))) %>'
                                                    CssClass='<%# "switchCheckbox" + ((Convert.ToBoolean(Eval("Canceled")) || Convert.ToBoolean(Eval("IsDefault"))) ? " add" : "")  %>'>
                                                </adv:PlainCheckBox>
                                            </EditItemTemplate>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="100" HeaderStyle-Width="100" AccessibleHeaderText="Buttons"
                                            ...
                                            <EditItemTemplate>
                                                <%-- <asp:LinkButton ID="buttonDelete" runat="server" CssClass="deletebtn showtooltip"
                                                    ToolTip='<%$ Resources:Resource, Admin_MasterPageAdminCatalog_Delete %>' CommandName="Delete"
                                                    CommandArgument='<%# Eval("ID") %>' Enabled='<%# !(AdvantShop.Demo.IsDemoEnabled()) %>'
