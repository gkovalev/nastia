<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Coupons.aspx.cs" Inherits="Admin_Coupons" %>
            ...
            <div>
                <div>
                    <adv:AdvButton ID="btnAdd" runat="server" Width="170" Text="<%$ Resources:Resource, Admin_HeadCmdInsert %>"
                        ...
                        CssCenterDiv="adv_OrangeButton_CenterDiv" OnClientClick="javascript:open_window('m_Coupon.aspx',750,600);return false;" />
                </div>
                        ...
                        <table class="filter" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 210px; text-align: center;">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlType" Width="90%" DataSourceID="edsCouponType"
                                        DataTextField="LocalizedName" DataValueField="Value" OnDataBound="ddl_DataBound">
                                    </asp:DropDownList>
                                </td>
                                ...
                                <td style="width: 180px;">
                                    ...
                                    <asp:TextBox CssClass="filtertxtbox" ID="txtMinimalPrice" Width="99%" runat="server"
                                        TabIndex="12" />
                                </td>
                            ...
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Value" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtValue" runat="server" Text='<%# Convert.ToDecimal(Eval("Value")).ToString("F2") %>'
                                                Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lValue" runat="server" Text='<%# Convert.ToDecimal(Eval("Value")).ToString("F2")  %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="ExpirationDate" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbOrderExpirationDate" runat="server" CommandName="Sort" CommandArgument="ExpirationDate">
                                                ...
                                                <asp:Image ID="arrowExpirationDate" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Uses" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Enabled" ItemStyle-Width="120" HeaderStyle-Width="120"
                                        ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <div style="width: 120px; height: 0px; font-size: 0px;">
                                            </div>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="MinimalOrderPrice" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbOrderMinimalOrderPrice" runat="server" CommandName="Sort" CommandArgument="MinimalOrderPrice">
                                                ...
                                                <asp:Image ID="arrowMinimalOrderPrice" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtMinimalOrderPrice" runat="server" Text='<%# Convert.ToDecimal(Eval("MinimalOrderPrice")).ToString("F2") %>'
                                                Width="99%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lMinimalOrderPrice" runat="server" Text='<%# Convert.ToDecimal(Eval("MinimalOrderPrice")).ToString("F2") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="85px" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:ImageButton ID="buttonDelete" runat="server" ImageUrl="images/deletebtn.png"
                                                CssClass="deletebtn showtooltip" CommandName="DeleteCoupon" CommandArgument='<%# Eval("ID")%>'
