<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Menu.aspx.cs" Inherits="Admin_Menu" %>
                                    ...
                                    <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Center">
                                                <EditItemTemplate>
                                                    <%# "<a href=\"javascript:open_window('m_Menu.aspx?MenuID=" + Eval("ID") + "&mode=edit&type=" + MenuType + "',750,600);\" class = 'editbtn showtooltip' title=\"" + Resources.Resource.Admin_MasterPageAdminMenu_EditLinks + "\" ><img src='admin/images/editbtn.gif' style='border: none;' /></a>"%>
