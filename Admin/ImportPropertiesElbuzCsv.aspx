...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div style="width: 600px; margin: 0 auto; text-align: justify;">
        ...
        <br />
        <p>
            1) Загрузите фотографии из директории big_images, полученные из системы E-Trade
            в директорию сайта ~\pictures_elbuz\.
        </p>
        <p>
            Формат имен изображений при выгрузке из системы E-Trade должен быть вида "p{ID}" (рис 2)
        </p>
        <p>
            Директория ~\pictures_elbuz\ должна содержать только файлы фотографий.
        </p>
        <p>
            После импорта фотографии продуктов из директории ~\pictures_elbuz\, которые соответствуют
            записям в файле csv, будут удалены, это означает, что фотографии успешно ассоциированы
            с продуктами.
        </p>
        <p>
            2) Файл *.csv с характеристиками (CSV - Матрица характеристик) загрузите в систему,
            используя форму загрузки на этой странице.
        </p>
