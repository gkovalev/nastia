...
public partial class OrderByRequest : Page
{
    ...
    {
        Page.Title = string.Format("{0} - {1}", SettingsMain.ShopName, Resource.Admin_OrderByRequest_Header);
    ...
    protected void lbDeleteSelected_Click(object sender, EventArgs e)
    {
        if ((_selectionFilter != null) && (_selectionFilter.Values != null))
        {
            if (!_inverseSelection)
            {
                ...
                {
                    OrderByRequestService.DeleteOrderByRequest(Convert.ToInt32(id));
                }
            }
            else
            {
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        {
            var orderByRequest = OrderByRequestService.GetOrderByRequest(Convert.ToInt32(grid.UpdatedRow["ID"]));

            if ((orderByRequest != null) && (orderByRequest.OrderByRequestId != 0))
            {
                orderByRequest.IsComplete = Convert.ToBoolean(grid.UpdatedRow["IsComplete"]);
