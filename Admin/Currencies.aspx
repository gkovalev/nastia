<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Currencies.aspx.cs" Inherits="Currencies" %>
                        ...
                        <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField AccessibleHeaderText="CurrencyValue" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtCurrencyValue" runat="server" Text='<%# Eval("CurrencyValue") %>'
                                            Width="99%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lCurrencyValue" runat="server" Text='<%# Bind("CurrencyValue") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
