<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChangePrice.ascx.cs" Inherits="UserControls_ChangePrice" %>
<asp:UpdatePanel ID="up" runat="server">
    <ContentTemplate>
        ...
        <asp:Label ID="Label1" runat="server" Text="<%$  Resources: Resource, Admin_ChangePrice_At %>"></asp:Label>
