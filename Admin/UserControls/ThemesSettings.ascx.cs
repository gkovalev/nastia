...
public partial class Admin_UserControls_Settings_DesignSettings : System.Web.UI.UserControl
{
    ...
    protected void bthAddTheme_Click(object sender, EventArgs e)
    {
        ...
        string filename = string.Format("{0}/design/{1}s/{2}", SettingsGeneral.AbsolutePath, DesignType.ToString(), ThemeLoad.FileName);
    ...
    private void InstallDesign(string url, string themeName)
    {
        try
        {
            ...
            {
                string filename = string.Format("{0}design\\{1}s\\{2}.zip", SettingsGeneral.AbsolutePath, DesignType.ToString(), themeName);
    ...
    private void UninstallDesign(string themeName)
    {
        ...
        {
            _currentDesigns = DesignService.GetDesigns(DesignType);
            string dirname = string.Format("{0}design\\{1}s\\{2}", SettingsGeneral.AbsolutePath, DesignType.ToString(), themeName);
