<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FedEx.ascx.cs" Inherits="Admin_UserControls_ShippingMethods_FedEx" %>
<table border="0" cellpadding="2" cellspacing="0" style="width: 99%; margin-left: 5px;
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtCountryCode" Width="250"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtPostalCode" Width="250"></asp:TextBox>
        </td>
        <td class="columnDescr">
            <asp:Image runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png"
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtAccountNumber" Width="250"></asp:TextBox>
        </td>
        <td class="columnDescr">
            <asp:Image runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png"
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtMeterNumber" Width="250"></asp:TextBox>
        </td>
        <td class="columnDescr">
            <asp:Image runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png"
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtRate" Width="250"></asp:TextBox>
        </td>
        <td class="columnDescr">
            <asp:Image runat="server" Width="18" Height="18" ImageUrl="~/Admin/images/messagebox_info.png"
