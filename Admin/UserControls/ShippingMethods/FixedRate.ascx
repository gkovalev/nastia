<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FixedRate.ascx.cs" Inherits="Admin_UserControls_ShippingMethods_FixedRate" %>
<table border="0" cellpadding="2" cellspacing="0" style="width: 99%; margin-left: 5px;
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtShippingPrice" Width="250"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td class="columnVal">
            <asp:TextBox runat="server" ID="txtDeliveryTime" Width="250"></asp:TextBox>
        </td>
        <td class="columnDescr">
