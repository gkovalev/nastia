<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MasterControl.ascx.cs"
    Inherits="Admin_UserControls_ShippingMethods_MasterControl" %>
        ...
        <td style="vertical-align: top">
            <asp:Repeater ID="rptrPayments" runat="server">
                <ItemTemplate>
                    ...
                    <asp:CheckBox ID="ckbUsePayment" runat="server" Text='<%#Eval("Name") %>' Checked='<%# Convert.ToInt32(Eval("Use")) == 0 %>' /><br />
                </ItemTemplate>
            </asp:Repeater>
        </td>
    </tr>
