<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResizeBrandPhotos.ascx.cs"
    Inherits="Admin_UserControls_ResizePhoto_Brand" %>
<table border="0" cellpadding="2" cellspacing="0">
    <tr class="rowPost">
        <td colspan="2" style="height: 34px;">
            <span class="spanSettCategory">
                <asp:Localize ID="Localize7" runat="server" Text="<%$ Resources:Resource, Admin_ResizePhotos_BrandLogo %>"></asp:Localize></span>
    ...
    <tr class="rowPost">
        <td colspan="2" style="height: 34px;">
            <div class="dvMailNotify">
                ...
                <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources:Resource, Admin_ResizePhotos_NotifyNewImages %>" />
                </div>
        </td>
    </tr>
    <tr>
