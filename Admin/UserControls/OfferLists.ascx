<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OfferLists.ascx.cs" Inherits="Admin_UserControls_OfferLists" %>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblHead" CssClass="AdminHead" runat="server" Text="<%$ Resources:Resource, Admin_OfferLists_Header %>"></asp:Label><br />
                                <asp:Label ID="lblSubHead" CssClass="AdminSubHead" runat="server" Text="<%$ Resources:Resource, Admin_OfferLists_SubHeader %>"></asp:Label>
                            </td>
                            <td>
                                <div style="float: right; padding-right: 20px">
                                    ...
                                    <div>
                                        <adv:AdvButton ID="btnAddOfferList" runat="server" Text="<%$ Resources:Resource, Admin_OfferLists_Add %>"
                                            ...
                                            CssCenterDiv="adv_OrangeButton_CenterDiv" ValidationGroup="0" OnClick="btnAddOfferList_Click" />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <ContentTemplate>
                                <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                    CellPadding="2" CellSpacing="0" Confirmation="<%$ Resources:Resource, Admin_OfferLists_Confirmation %>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="checkboxcolumn" ItemStyle-Width="70px" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="Name" HeaderStyle-HorizontalAlign="Left">
                                            <HeaderTemplate>
                                                ...
                                                <asp:LinkButton ID="lbName" runat="server" CommandName="Sort" CommandArgument="Name">
                                                    <%=Resources.Resource.Admin_OfferLists_Name %>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center"
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="buttonDelete"
                                                    ConfirmText="<%$ Resources:Resource, Admin_OfferLists_Confirmation %>">
                                            ...
                                            <FooterTemplate>
                                                <asp:ImageButton ID="ibAddOfferList" runat="server" ImageUrl="~/admin/images/addbtn.gif" CommandName="AddOfferList"
                                                    ToolTip="<%$ Resources:Resource, Admin_Add  %>" />
                                                <asp:ImageButton ID="ibCancelAdd" runat="server" ImageUrl="~/admin/images/cancelbtn.png"
                                    ...
                                    <EmptyDataTemplate>
                                        <center style="margin-top: 20px; margin-bottom: 20px;">
                                            <%=Resources.Resource.Admin_OfferLists_NoRecords%>
                                        </center>
                                    </EmptyDataTemplate>
                                </adv:AdvGridView>
            ...
            $("#commandButton").click(function () {
                ...
                switch (command) {
                    ...
                    case "unselectVisible":
                        ...
                        break;
                    case "deleteSelected":
                        var r = confirm("<%= Resources.Resource.Admin_OfferLists_Confirm%>");
