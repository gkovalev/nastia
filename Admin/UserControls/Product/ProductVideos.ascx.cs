...
public partial class Admin_UserControls_ProductVideos : System.Web.UI.UserControl
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (grid_video.UpdatedRow != null)
        {
            ...
            {
                ProductVideoService.UpdateProductVideo(Convert.ToInt32(grid_video.UpdatedRow["ProductVideoID"]), grid_video.UpdatedRow["Name"], sortOrder);
            }
        }
