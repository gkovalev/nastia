...
public partial class Admin_UserControls_Product_RightNavigation : System.Web.UI.UserControl
{
    ...
    {
        Paging.CurrentPageIndex = Convert.ToInt32(ddlCurrentPage.SelectedValue);
    }
    ...
    protected void rCategoryContent_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            var parentCategory = (CategoryService.GetCategory(Convert.ToInt32(e.CommandArgument))).ParentCategoryId;
        ...
        {
            ProductService.DeleteProductLink(Convert.ToInt32(e.CommandArgument), CategoryID);
    ...
    public void RedirectFromUpdatePanel(string url)
    {
        ...
        ScriptManager.RegisterStartupScript(this, typeof(Page), "RedirectFromUpdatePanel", script, true);
    }
