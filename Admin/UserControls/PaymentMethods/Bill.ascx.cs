...
public partial class Admin_UserControls_PaymentMethods_Bill : ParametersControl
{
    public override Dictionary<string, string> Parameters
    {
        ...
        set
        {
            ...
            txtKPP.Text = value.ElementOrDefault(BillTemplate.KPP).IsNotEmpty() ? value.ElementOrDefault(BillTemplate.KPP) : SettingsBank.KPP;
            ...
            txtManager.Text = value.ElementOrDefault(BillTemplate.Manager).IsNotEmpty() ? value.ElementOrDefault(BillTemplate.Manager) : SettingsBank.Manager;
