<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Bill.ascx.cs" Inherits="Admin_UserControls_PaymentMethods_Bill" %>
<table border="0" cellpadding="2" cellspacing="0" style="width: 99%; margin-left: 5px;
    ...
    <tr>
        <td class="columnName">
            <asp:Localize ID="Localize15" runat="server" Text="<%$ Resources:Resource, Admin_PaymentMethod_Bill_KPP %>"></asp:Localize><span class="required">&nbsp;*</span>
        </td>
        <td class="columnVal">
    ...
    <tr>
        <td class="columnName">
            <asp:Localize ID="Localize25" runat="server" Text="<%$ Resources:Resource, Admin_PaymentMethod_Bill_Manager %>"></asp:Localize><span class="required">&nbsp;*</span>
        </td>
        <td class="columnVal">
