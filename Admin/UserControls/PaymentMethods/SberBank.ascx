<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SberBank.ascx.cs" Inherits="Admin_UserControls_PaymentMethods_SberBank" %>
<table border="0" cellpadding="2" cellspacing="0" style="width: 99%; margin-left: 5px;
    ...
    <tr>
        <td class="columnName">
            <asp:Localize runat="server" Text="<%$ Resources:Resource, Admin_PaymentMethod_Bill_KPP %>"></asp:Localize><span class="required">&nbsp;*</span>
        </td>
        <td class="columnVal">
