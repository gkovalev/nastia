...
public partial class Admin_UserControls_PaymentMethods_SberBank : ParametersControl
{
    public override Dictionary<string, string> Parameters
    {
        get
        {
            return _valid || ValidateFormData(new[] { txtCurrencyValue, txtCompanyName, txtTransAccount, txtINN, txtKPP, txtBankName, txtCorAccount, txtBIK }, new[] {txtCurrencyValue})
