...
public partial class Admin_UserControls_OrdersAnnualChart : System.Web.UI.UserControl
{
    ...
    protected string RenderJGData()
    {
        ...
        Dictionary<DateTime, decimal> data = OrderStatisticsService.GetOrdersSumByPeriod(minDate, maxDate);
        if (data == null)
        {
            return "";
        }
