...
public partial class Admin_UserControls_Settings_BankSettings : System.Web.UI.UserControl
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (!string.IsNullOrWhiteSpace(SettingsBank.StampImageName))
        {
            ...
            imgStamp.ImageUrl = FoldersHelper.GetPath(FolderType.Pictures, SettingsBank.StampImageName, true);
        }
        else
        {
