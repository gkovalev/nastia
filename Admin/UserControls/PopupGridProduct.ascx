<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PopupGridProduct.ascx.cs"
    EnableViewState="true" Inherits="Admin_UserControls_PopupGridProduct" %>
...
<asp:Panel ID="modalPopup" runat="server" CssClass="modal-admin">
            <div class="title"><%= Resources.Resource.Admin_mMenu_Products %></div>
                                ...
                                <asp:TemplateField AccessibleHeaderText="ArtNo" ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <asp:LinkButton ID="lbArtNo" runat="server" CommandName="Sort" CommandArgument="ArtNo"
                                            ...
                                            <%= Resources.Resource.Admin_mMenu_AtrNo %><asp:Image ID="arrowArtNo" CssClass="arrow" runat="server" ImageUrl="../images/arrowdownh.gif" />
                                        </asp:LinkButton>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField AccessibleHeaderText="Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <asp:LinkButton ID="lbName" runat="server" CommandName="Sort" CommandArgument="Name"
                                            CausesValidation="false">
                                            <%= Resources.Resource.Admin_mMenu_Name %><asp:Image ID="arrowName" CssClass="arrow" runat="server" ImageUrl="../images/arrowdownh.gif" />
                                        </asp:LinkButton>
                                    </HeaderTemplate>
                                    <ItemTemplate>
