<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GeneralSettings.ascx.cs"
    Inherits="Admin_UserControls_Settings_GeneralSettings" %>
...
<table border="0" cellpadding="2" cellspacing="0">
    ...
    <tr>
        ...
        <td style="vertical-align: top">
            <asp:Panel ID="pnlFavicon" runat="server" Width="100%">
                <div class="dvFaviIco">
                    <adv:Favicon ID="Favicon" runat="server" GetOnlyImage="true" CssClassImage="imgFaviIco" />
                </div>
    ...
    <tr id="trChangeAdminPass" runat="server">
        ...
        <td style="vertical-align: top">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:LinkButton ID="lbChangeAdminPassword" runat="server" Text="<%$ Resources:Resource, Admin_CommonSettings_Change %>"
                        OnClick="lbChangeAdminPassword_Click" />
                    ...
                    <asp:Panel runat="server" ID="tblChangeAdminPassword" Visible="false">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="txtPassword" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator
                                            ControlToValidate="txtPassword" ID="rfvPassword" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="txtConfirmPassword" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Button runat="server" ID="btnChangeAdminPassword" Text="<%$ Resources:Resource, Admin_CommonSettings_Change %>"
                                            OnClick="btnChangeAdminPassword_Click" /><asp:Button runat="server" ID="btnCancelChangingAdminPassword"
                                                Text="<%$ Resources:Resource, Admin_Cancel %>" CausesValidation="false" OnClick="btnCancelChangingAdminPassword_Click" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <script type="text/javascript">
                        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(
                            function () {
                                if ($("#<%=passChange.ClientID %>").val()) {
                                    tabInit();
                                    $("#<%=passChange.ClientID %>").val('false');
                                }
                            }
                        )
                    </script>
                    <asp:HiddenField runat="server" ID="passChange" Value="false" />
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
    ...
    <tr>
        <td style="width: 250px; height: 34px; text-align: left; vertical-align: top;">
            <asp:Localize ID="Localize1" runat="server" Text="<%$ Resources:Resource, Admin_CommonSettings_EnableUsersOnline %>"></asp:Localize>
            <br />
        </td>
        <td style="vertical-align: top;">
            <asp:CheckBox runat="server" ID="ChbEnableUserOnline" />
        </td>
    </tr>
    <tr>
        <td style="width: 250px; height: 34px; text-align: left; vertical-align: top;">
            <asp:Localize ID="Localize2" runat="server" Text="<%$ Resources:Resource, Admin_CommonSettings_SearchIndex %>"></asp:Localize>
            <br />
        </td>
        <td style="vertical-align: top;">
            <asp:Button runat="server" ID="btnDoindex" Text="<%$ Resources:Resource, Admin_CommonSettings_Generate %>"
