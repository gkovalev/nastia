<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ExportFeed.aspx.cs" Inherits="Admin_ExportFeed" %>
                                ...
                                <div>
                                    <div class="catalog_Link" style="clear: both">
                                        ...
                                        <div style="float: right; margin-top: 10px;">
                                            <asp:Button runat="server" ID="btnResetExport" Height="25px" Text="<%$ Resources:Resource, Admin_ExportFeed_ResetButton %>" OnClick="btnResetExport_OnClick" />&nbsp;
                                            <div class="adv_OrangeButton_Main">
                                                ...
                                                <div class="adv_OrangeButton_CenterDiv2">
                                                    <input name="btnExport" class="adv_OrangeButton_Input" id="btnExport" style="width: 200px;"
                                                        onclick="window.location='ExportFeedProgress.aspx?ModuleId=<% = ModuleName %>&amp;start=yes';"
