<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Brands.aspx.cs" Inherits="Admin_Brands" %>
                        ...
                        <ContentTemplate>
                            <adv:AdvGridView ID="grid" runat="server" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="BrandLogo" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="BrandName" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            ...
                                            <asp:LinkButton ID="lbOrderBrandName" runat="server" CommandName="Sort" CommandArgument="BrandName">
                                                ...
                                                <asp:Image ID="arrowBrandName" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="ProductsCount" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="Enabled" ItemStyle-Width="140" HeaderStyle-Width="140"
