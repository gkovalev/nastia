...
public partial class Admin_PropertyValues : Page
{
    ...
    protected void lbDeleteSelected_Click(object sender, EventArgs e)
    {
        if ((_selectionFilter != null) && (_selectionFilter.Values != null))
        {
            if (!_inverseSelection)
            {
                ...
                {
                    PropertyService.DeletePropertyValueById(Convert.ToInt32(id));
                }
            }
            else
            {
    ...
    protected void grid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            PropertyService.DeletePropertyValueById(Convert.ToInt32(e.CommandArgument));
        }
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (grid.UpdatedRow != null)
        {
            ...
            PropertyService.UpdatePropertyValue(new PropertyValue
                                                    {
                                                        PropertyValueId = Convert.ToInt32(grid.UpdatedRow["ID"]),
                                                        Value = grid.UpdatedRow["Value"],
                                                        PropertyId = Convert.ToInt32(grid.UpdatedRow["PropertyID"]),
                                                        SortOrder = sortOrder
                                                    }
                                               );
        }
