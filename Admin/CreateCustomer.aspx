<%@ Page AutoEventWireup="true" CodeFile="CreateCustomer.aspx.cs" Inherits="Admin_CreateCustomer"
...
<asp:Content ID="ContentViewCustomer" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <br />
    <div style="text-align: center;">
        <asp:Button ID="btnChangeCommonInfo" runat="server" Text="<%$ Resources:Resource, Admin_Update %>"
            OnClientClick="return ValidateData();" OnClick="btnChangeCommonInfo_Click" /></div>
    <br />
    <br />
    <div style="text-align: center;">
