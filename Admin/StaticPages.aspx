<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="StaticPages.aspx.cs" Inherits="Admin_StaticPages" %>
                            ...
                            <tr style="height: 28px;">
                                ...
                                <td style="width: 22px;" align="right">
                                    <asp:ImageButton ID="ibtnAddInRoot" runat="server" ImageUrl="images/gplus.gif" onmouseover="this.src='images/bplus.gif'"
                                        onmouseout="this.src='images/gplus.gif';" ToolTip="<%$ Resources:Resource, Admin_StaticPage_AddPage %>" OnClick="ibtnAddInRoot_Click" />
                                </td>
                            </tr>
                        </table>
