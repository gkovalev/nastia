<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="ImportElbuzCsv.aspx.cs" Inherits="Admin_ImportElbuzCsv" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <div id="mainDiv" runat="server">
        <center>
            ...
            <asp:Label ID="lblAdminSubHead" runat="server" CssClass="AdminSubHead" Text="<%$ Resources:Resource, Admin_ImportElbuzCsv_CatalogUpload %>"></asp:Label>
            <br />
        </center>
        <br />
        <br />
                        ...
                        $(document).ready(function () {
                            ...
                            $.fjTimer({
                                ...
                                tick: function (counter, timerId) {
                                    ...
                                    jQuery.ajax({
                                        url: "../HttpHandlers/ImportElbuzCsv_Data.ashx",
                                        dataType: "json",
                                        cache: false,
