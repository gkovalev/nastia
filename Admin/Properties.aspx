<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Properties.aspx.cs" Inherits="Admin_Properties" %>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="UseInFilter" ItemStyle-Width="200" HeaderStyle-Width="200"
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lbOrderUseInFilter" runat="server" CommandName="Sort" CommandArgument="UseInFilter">
                                                ...
                                                <asp:Image ID="arrowUseInFilter" CssClass="arrow" runat="server" ImageUrl="images/arrowdownh.gif" /></asp:LinkButton>
                                        </HeaderTemplate>
                                        <EditItemTemplate>
                                            <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%# Bind("UseInFilter") %>' />
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Bind("UseInFilter") %>'
                                                Enabled="false" />
                                        </ItemTemplate>
                                        <FooterTemplate>
