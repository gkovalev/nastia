<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StoreReviewsClientPage.ascx.cs"
    Inherits="Advantshop.UserControls.Modules.StoreReviews.StoreReviewsClientPage" %>
<%@ Import Namespace="AdvantShop.Configuration" %>
<%@ Import Namespace="AdvantShop.Modules" %>
<link rel="stylesheet" href="modules/storereviews/module-css/storereviews.css" />
<link rel="stylesheet" href="modules/storereviews/module-js/module-validate/validate.css" />
<h1>
    <asp:Label runat="server" ID="ltHeader" Text='<%$ Resources: StoreReviews_StoreReviews%>'></asp:Label>
</h1>
    ...
    <asp:ListView ID="lvStoreReviews" runat="server" ItemPlaceholderID="itemPlaceHolderId"
        ...
        <ItemTemplate>
            <div class="shop-reviews-wrap pie" data-sr-item="<%# Eval("Id") %>" data-sr-parentid="<%# Eval("ParentId") %>">
                <asp:Panel CssClass="shop-reviews-row" runat="server" Visible='<%# Convert.ToDouble(Eval("Rate").ToString()) > 0 %>'>
