...
(function ($) {
    ...
    validateElemStoreFaqs = validateElemStoreFaqs || validateElem;
    ...
    $(window).load(validateElem.prototype.InitTotal);
    ...
    validateElem.prototype.message = {
        email: localizeStoreFaqs('StoreFaqsValidEmail'),
        required: localizeStoreFaqs('StoreFaqsValidRequired')
    };

    validateElem.prototype.iconHtml = '<span class="validelem-icon"></span>';
    validateElem.prototype.messageHtml = '<div class="validelem-message pie"></div>';
